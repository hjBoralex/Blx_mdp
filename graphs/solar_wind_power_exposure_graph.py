        ...
        dcc.Graph(id='sol_wp_exp_y',
                  figure = {'data':[
                      go.Bar(
                          name='Solar',
                          x=years['years'],
                          y=query_results_31['exposure_sol_year'],
                      ...
                      go.Bar(
                          name='Wind Power',
                          x=years['years'],
                          y=query_results_32['exposure_eol_year'],
        ...
        dcc.Graph(id='sol_wp_exp_q', 
                  figure = {'data':[
                      go.Bar(
                          name='Solar',
                          x=quarters['quarters'],
                          y=query_results_33['exposure_sol_qtr'],
                          marker=dict(color=colors['e_white']),
                          opacity=0.15
                          ),
                      go.Bar(
                          name='Wind Power',
                          x=quarters['quarters'],
                          y=query_results_34['exposure_eol_qtr'],
                          marker=dict(color=colors['e_white_1']),
                          opacity=0.45
                          )
                      ], 
        ...
        dcc.Graph(id='sol_wp_exp_m',
                  figure = {'data':[
                      go.Bar(
                          name='Solar',
                          x=months['months'],
                          y=query_results_35['exposure_sol_mth'],
                          marker=dict(color=colors['e_white']),
                          opacity=0.15
                          ),
                      go.Bar(
                          name='Wind Power',
                          x=months['months'],
                          y=query_results_36['exposure_eol_mth'],
                          marker=dict(color=colors['e_white_1']),
                          opacity=0.45
                          )
                      ], 
